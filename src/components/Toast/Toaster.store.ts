...
//isAnimation is deprecated insted use isOpen with useEnterAnimation and useExitAnimation from react-aria
//And in the concept th eanimation should be manage by the framework itself
...
class ToastService {
    private createToast(props?: ToastAllProps): string {
        ...
        const id = props?.id ?? customUUID({ prefix: 'toast=' });
