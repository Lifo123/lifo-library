...
export default function ButtonPromise({ loadingId = 'G_Fetch', text, className, style, onClick, size }: ButtonProps) {
    ...
    return (
        <button className={`d-flex f-center relative ${className || 'btn-primary rounded-md btn pointer fs-2'}`} onClick={handleClick} style={style} data-btn-promise={loadingId}>
            {
